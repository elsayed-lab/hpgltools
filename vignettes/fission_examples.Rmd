...
all_pairwise = balanced_pairwise(exprs(norm_expt$expressionset), norm_expt$conditions, norm_expt$batches)
...
wt_120 = all_pairwise$limma_result$wt.120
mut_120 = all_pairwise$limma_result$mut.120

hpgl_linear_scatter(df=data.frame(wt=wt_120$AveExpr, mut=mut_120$AveExpr))
