...
compare_12 = hpgl_qq_plot(norm_expt, x=1, y=2)
compare_12$log
...
summary(all_pairwise$all_tables$wt.120_vs_mut.120)
...
all_comparison = suppressMessages(all_pairwise(normbatch_expt))
all_combined <- combine_de_tables(all_comparison)
sig_genes <- extract_significant_genes(all_combined)
