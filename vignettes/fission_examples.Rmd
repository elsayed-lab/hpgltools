...
all_pairwise = limma_pairwise(expt=normbatch_expt, conditions=norm_expt$conditions, batches=norm_expt$batches)
...
scatter_wt_mut = coefficient_scatter(all_pairwise, x="wt.120", y="mut.120", gvis_filename=NULL)
...
all_comparison = all_pairwise(expt=normbatch_expt)
