...
limma_comparison <- limma_pairwise(normbatch_expt)
...
deseq_comparison <- deseq2_pairwise(fission_expt, model_batch=TRUE)
summary(deseq_comparison$all_tables$wt.120_vs_mut.120)

edger_comparison <- edger_pairwise(fission_expt, model_batch=TRUE)
summary(edger_comparison$all_tables$wt.120_vs_mut.120)

basic_comparison <- basic_pairwise(fission_expt)
summary(basic_comparison$all_tables$wt.120_vs_mut.120)

all_comparisons <- all_pairwise(fission_expt, model_batch=TRUE)
