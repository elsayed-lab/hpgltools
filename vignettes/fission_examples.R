...
sf_expt = normalize_expt(expt=fission_expt, norm="sf")
hpgl_boxplot(expt=sf_expt)
tm_expt = normalize_expt(expt=fission_expt, norm="tmm")
hpgl_boxplot(expt=tm_expt)
rle_expt = normalize_expt(expt=fission_expt, norm="rle")
hpgl_boxplot(expt=rle_expt)
up_expt = normalize_expt(expt=fission_expt, norm="upperquartile")
