## mlseq.r: An initial implementation of the MLSeq pipeline.  I never completed
## this because I am increasingly suspicious that ML methods are poorly equipped
## to deal with differential expression analyses.
