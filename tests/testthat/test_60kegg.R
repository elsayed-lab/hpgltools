...
tt <- s_p(require.auto("org.Dm.eg.db"))
...
pct_citrate <- s_p(pct_kegg_diff(all_ids, sig_ids, organism="dme"))$result
...
all_percentages <- s_p(pct_all_kegg(all_ids, sig_ids, pathways=pathways, organism="dme"))$result
