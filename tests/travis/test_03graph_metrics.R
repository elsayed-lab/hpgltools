...
expected <- c(42.04206, 35.83188, 42.04206, 36.22210, 40.23671, 39.84791)
## 10
...
expected <- c(-77.47983, -69.03152, 504.50420, 504.48751, -284.84188, -287.83412, -289.80436)
...
expected <- c(443.10390, 440.03829, -15.94329, -24.94180, -292.96522, -279.18136)
## These also changed.
## 17
...
expected <- c(0.5651761, 0.6593803, 0.5651761, 0.6593803, 0.5651761, 0.6593803)
...
expected <- c(0.1413681, 0.3237510, 0.1413681, 0.3237510, 0.1413681, 0.3237510)
## 19
test_that("Is the tsne r-squared by condition as expected?", {
    expect_equal(expected, actual, tolerance=0.001)
})
