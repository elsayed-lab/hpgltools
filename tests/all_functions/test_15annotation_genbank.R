...
library(testthat)
library(hpgltools)
context("15annotation_genbank.R: Test functions in annotation_genbank.r")
...
message(paste0("\nFinished 15annotation_genbank.R in ", elapsed,  " seconds."))
